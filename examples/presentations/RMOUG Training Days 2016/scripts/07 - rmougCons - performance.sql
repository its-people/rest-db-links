...
select symbol
     ...
     , cast( to_timestamp_tz(to_char(to_date(tstamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"'), 'YYYY-MM-DD HH24:MI:SS "UTC"'), 'YYYY-MM-DD HH24:MI:SS TZR')
             at time zone sessiontimezone as date ) tstamp
  from table(http_rest_response('http://192.168.56.101:8080/ords/rmougprov/tab-StockTicker/?limit=100')) t
     , json_table(t.response, '$.items[*]'
                   columns ( symbol  varchar2 path '$.symbol'
                           , tstamp  varchar2 path '$.tstamp'
                           , price   varchar2 path '$.price'
...
select symbol
     ...
     , cast( to_timestamp_tz(to_char(to_date(tstamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"'), 'YYYY-MM-DD HH24:MI:SS "UTC"'), 'YYYY-MM-DD HH24:MI:SS TZR')
             at time zone sessiontimezone as date ) tstamp
  from table(http_rest_response('http://192.168.56.101:8080/ords/rmougprov/tab-StockTicker/?limit=500')) t
     , json_table(t.response, '$.items[*]'
                   columns ( symbol  varchar2 path '$.symbol'
                           , tstamp  varchar2 path '$.tstamp'
                           , price   varchar2 path '$.price'
...
select symbol
     ...
     , cast( to_timestamp_tz(to_char(to_date(tstamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"'), 'YYYY-MM-DD HH24:MI:SS "UTC"'), 'YYYY-MM-DD HH24:MI:SS TZR')
             at time zone sessiontimezone as date ) tstamp
  from table(http_rest_response('http://192.168.56.101:8080/ords/rmougprov/tab-StockTicker/?limit=5000')) t
     , json_table(t.response, '$.items[*]'
                   columns ( symbol  varchar2 path '$.symbol'
                           , tstamp  varchar2 path '$.tstamp'
                           , price   varchar2 path '$.price'
...
select symbol
     ...
     , cast( to_timestamp_tz(to_char(to_date(tstamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"'), 'YYYY-MM-DD HH24:MI:SS "UTC"'), 'YYYY-MM-DD HH24:MI:SS TZR')
             at time zone sessiontimezone as date ) tstamp
  from table(http_rest_response('http://192.168.56.101:8080/ords/rmougprov/tab-StockTicker/?limit=10000')) t
     , json_table(t.response, '$.items[*]'
                   columns ( symbol  varchar2 path '$.symbol'
                           , tstamp  varchar2 path '$.tstamp'
                           , price   varchar2 path '$.price'
...
select symbol
     ...
     , cast( to_timestamp_tz(to_char(to_date(tstamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"'), 'YYYY-MM-DD HH24:MI:SS "UTC"'), 'YYYY-MM-DD HH24:MI:SS TZR')
             at time zone sessiontimezone as date ) tstamp
  from table(http_rest_response('http://192.168.56.101:8080/ords/rmougprov/tab-StockTicker/?limit=15000')) t
     , json_table(t.response, '$.items[*]'
                   columns ( symbol  varchar2 path '$.symbol'
                           , tstamp  varchar2 path '$.tstamp'
                           , price   varchar2 path '$.price'
